...
- 📅 **July calendar** — tap any day to toggle it dry/not-dry
- 💸 **Live stats** — money saved, calories avoided, current & longest streak
- 🌐 **Community feed** — real-time `#dryjuly` posts from across Nostr
