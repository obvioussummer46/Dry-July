...
- 🔥 **One home screen** — animated streak ring over a month calendar; tap any day (today included) to log it
- 📅 **Month navigation** — browse and log any month, not just the challenge window
